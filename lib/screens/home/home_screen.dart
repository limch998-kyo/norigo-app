...
class _KoreaQuickPlans extends StatelessWidget {
  ...
  static const _plans = [
    {'id': 'seoul-classic', 'region': 'seoul', 'image': '/images/landmarks/myeongdong.webp',
     'title': {'ja': '明洞・景福宮・弘大', 'ko': '명동·경복궁·홍대', 'en': 'Myeongdong · Gyeongbokgung · Hongdae', 'fr': 'Myeongdong · Gyeongbokgung · Hongdae'},
     'subtitle': {'ja': 'ソウル定番コース', 'ko': '서울 핵심 코스', 'en': 'Classic Seoul', 'fr': 'Séoul classique'},
     'landmarks': [
    ...
    {'id': 'seoul-trend', 'region': 'seoul', 'image': '/images/landmarks/lotte-world.webp',
     'title': {'ja': '江南・梨泰院・ロッテタワー', 'ko': '강남·이태원·롯데타워', 'en': 'Gangnam · Itaewon · Lotte Tower', 'fr': 'Gangnam · Itaewon · Lotte Tower'},
     'subtitle': {'ja': 'トレンド＆ショッピング', 'ko': '트렌드 & 쇼핑', 'en': 'Trend & Shopping', 'fr': 'Tendances & Shopping'},
     'landmarks': [
    ...
    {'id': 'seoul-culture', 'region': 'seoul', 'image': '/images/landmarks/insadong.webp',
     'title': {'ja': '仁寺洞・北村・Nタワー', 'ko': '인사동·북촌·N타워', 'en': 'Insadong · Bukchon · N Tower', 'fr': 'Insadong · Bukchon · Tour N'},
     'subtitle': {'ja': '歴史＆文化', 'ko': '역사 & 문화', 'en': 'History & Culture', 'fr': 'Histoire & Culture'},
     'landmarks': [
    ...
    {'id': 'busan-classic', 'region': 'busan', 'image': '/images/landmarks/haeundae.webp',
     'title': {'ja': '海雲台・広安里・西面', 'ko': '해운대·광안리·서면', 'en': 'Haeundae · Gwangalli · Seomyeon', 'fr': 'Haeundae · Gwangalli · Seomyeon'},
     'subtitle': {'ja': '釜山ビーチ＆グルメ', 'ko': '부산 해변 & 먹거리', 'en': 'Busan Beach & Food', 'fr': 'Plages & gastronomie de Busan'},
     'landmarks': [
    ...
    {'id': 'busan-culture', 'region': 'busan', 'image': '/images/landmarks/gamcheon-culture-village.webp',
     'title': {'ja': '甘川文化村・南浦洞', 'ko': '감천문화마을·남포동', 'en': 'Gamcheon · Nampo-dong', 'fr': 'Gamcheon · Nampo-dong'},
     'subtitle': {'ja': 'アート＆ローカル', 'ko': '예술 & 로컬', 'en': 'Art & Local', 'fr': 'Art & Local'},
     'landmarks': [

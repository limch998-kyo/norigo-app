        ...
        children: [
              ...
              Positioned.fill(
                child: Opacity(
                  ...
                  child: SvgPicture.asset(
                    _koreaMode
                        ? 'assets/images/illustrations/korea-hero-bg.svg'
                  ...
                  children: [
                    ...
                    Text(
                      _koreaMode
                          ? tr(
                              locale,
                              ja: 'ソウル・釜山の観光地を入力するだけで、すべてに近い最適なホテルエリアを提案。',
                              ko: '서울·부산의 관광지를 입력하면 최적의 호텔 지역을 추천합니다.',
                              en: 'Enter Seoul/Busan landmarks, we find the best hotel area.',
                              zh: '输入首尔·釜山的景点，为您推荐最佳酒店区域。',
                              fr: 'Entrez vos sites à Séoul/Busan, nous trouvons le meilleur quartier hôtelier.',
                            )
                          : l10n.homeSubtitle,
                  ...
                  Expanded(
                    child: _ServiceCard(
                      ...
                      subtitle: tr(
                        ...
                        ja: 'みんなの中間地点',
                        ko: '관광지에서 호텔 찾기',
                        en: 'Find hotels near landmarks',
                        zh: '在景点附近找酒店',
                        fr: 'Trouvez des hôtels près des sites',
                      ),
                  ...
                  Expanded(
                    child: _ServiceCard(
                      ...
                      subtitle: tr(
                        ...
                        ja: '観光地からホテルを探す',
                        ko: '모두의 중간 지점',
                        en: 'Find the middle point',
                        zh: '找到大家的中间地点',
                        fr: 'Trouvez le point central',
                      ),
            ...
            Padding(
              ...
              child: QuickPlanCards(
                onPlanSelected: (planId, region, landmarks) {
                  ...
                  // Go straight to the result/loading screen — no second tap needed.
                  onSwitchTab?.call(1);
                  notifier.search();
                },
              ),
          ...
          if (_koreaMode)
            Padding(
              ...
              child: _JapanBanner(
                locale: locale,
                onTap: () => setState(() => _koreaMode = false),
              ),
            ),
          const SizedBox(height: 32),
    ...
    switch (locale) {
      case 'ja':
        return [
          {
            'title': '出発駅を入力',
            'desc': '友達の出発駅を入力するだけでOK',
            'illustration': 'assets/images/illustrations/meetup-step1.svg',
          },
          {
            'title': '最適な中間駅を提案',
            'desc': 'みんなに公平な駅と周辺のお店を表示',
            'illustration': 'assets/images/illustrations/meetup-step2.svg',
          },
          {
            'title': '共有して決定',
            'desc': 'LINEやリンクで友達にそのまま送信',
            'illustration': 'assets/images/illustrations/meetup-step3.svg',
          },
        ];
      case 'ko':
        return [
          {
            'title': '관광지 입력',
            'desc': '가고 싶은 관광지를 2개 이상 입력',
            'illustration': 'assets/images/illustrations/stay-step1.svg',
          },
          {
            'title': 'AI가 최적 지역 분석',
            'desc': '모든 관광지에 접근하기 좋은 호텔 지역 계산',
            'illustration': 'assets/images/illustrations/stay-step2.svg',
          },
          {
            'title': '호텔 예약',
            'desc': '추천 지역에서 호텔을 골라 예약',
      ...
      case 'fr':
        return [
          {
            'title': 'Entrez vos sites',
            'desc': 'Ajoutez 2+ sites touristiques à visiter',
            'illustration': 'assets/images/illustrations/stay-step1.svg',
          },
          {
            'title': 'L\'IA trouve le meilleur quartier',
            'desc': 'Nous calculons le quartier hôtelier le mieux situé',
            'illustration': 'assets/images/illustrations/stay-step2.svg',
          },
          {
            'title': 'Réservez votre hôtel',
            'desc': 'Choisissez et réservez parmi les hôtels recommandés',
            'illustration': 'assets/images/illustrations/stay-step3.svg',
          },
        ];
      default:
        return [
          {
            'title': 'Enter Landmarks',
            'desc': 'Add 2+ tourist spots you want to visit',
            'illustration': 'assets/images/illustrations/stay-step1.svg',
          },
          {
            'title': 'AI Finds Best Area',
            'desc': 'We calculate the hotel area with best access to all spots',
            'illustration': 'assets/images/illustrations/stay-step2.svg',
          },
          {
            'title': 'Book Your Hotel',
            'desc': 'Choose and book from recommended hotels',
            'illustration': 'assets/images/illustrations/stay-step3.svg',
          },
        ];
    }
                ...
                children: [
                  Text(
                    tr(
                      locale,
                      ja: '韓国もサポート！',
                      en: 'Korea Now Available!',
                      zh: '韩国现已支持！',
                      fr: 'Corée maintenant disponible !',
                    ),
                  ...
                  Text(
                    tr(
                      locale,
                      ja: 'ソウル・釜山のホテル検索ができます',
                      en: 'Search hotels in Seoul & Busan',
                      zh: '可搜索首尔·釜山的酒店',
                      fr: 'Recherchez des hôtels à Séoul et Busan',
                    ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: AppTheme.isDark
                ? [const Color(0xFF2D1B1B), const Color(0xFF2D2418)]
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    tr(
                      locale,
                      ja: '東京・大阪のホテルと集合場所を探す',
                      ko: '도쿄·오사카 호텔과 모임 장소',
                      en: 'Hotels in Tokyo & Osaka',
                      zh: '搜索东京·大阪的酒店和聚会地点',
                      fr: 'Hôtels à Tokyo et Osaka',
                    ),
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: AppTheme.mutedForeground,
                    ),
    ...
    final steps = [
      {
        'title': tr(
          ...
          ja: '韓国の観光地を入力',
          ko: '한국 관광지 입력',
          en: 'Enter Korea landmarks',
          zh: '输入韩国景点',
          fr: 'Entrez les sites coréens',
        ),
        'desc': tr(
          locale,
          ja: 'ソウル・釜山の行きたいスポットを入力',
          ko: '서울·부산의 가고 싶은 관광지를 입력',
          en: 'Add Seoul/Busan spots',
          zh: '输入想去的首尔·釜山景点',
          fr: 'Ajoutez des sites à Séoul/Busan',
        ),
      ...
      },
      {
        'title': tr(
          ...
          ja: 'ベストなエリアを提案',
          ko: '최적 지역 추천',
          en: 'Best area recommended',
          zh: '推荐最佳区域',
          fr: 'Meilleur quartier recommandé',
        ),
        'desc': tr(
          locale,
          ja: 'すべての観光地にアクセスしやすいホテルエリアを算出',
          ko: '모든 관광지에 접근하기 좋은 호텔 지역을 계산',
          en: 'Hotel area closest to all spots',
          zh: '计算距所有景点最近的酒店区域',
          fr: 'Quartier hôtelier le plus proche de tous les sites',
        ),
  ...
  static const _plans = [
    {
      'id': 'seoul-myeongdong',
      'region': 'seoul',
      'image': '/images/landmarks/myeongdong.webp',
      'title': {
        'ja': '明洞・景福宮・北村',
        'ko': '명동・경복궁・북촌',
        'en': 'Myeongdong · Gyeongbokgung · Bukchon',
        'zh': '明洞・景福宫・北村',
        'fr': 'Myeongdong · Gyeongbokgung · Bukchon',
      },
      'subtitle': {
        'ja': '初めての韓国旅行におすすめ',
        'ko': '처음 서울 여행하는 분에게 추천',
        'en': 'Perfect for first-time visitors',
        'zh': '首次韩国旅行推荐',
        'fr': 'Parfait pour une première visite',
      },
      'landmarks': [
        {
          'name': '明洞',
    ...
    },
    {
      'id': 'seoul-hongdae',
      'region': 'seoul',
      'image': '/images/landmarks/hongdae.webp',
      'title': {
        'ja': '弘大・延南洞・新村',
        'ko': '홍대・연남동・신촌',
        'en': 'Hongdae · Yeonnam · Sinchon',
        'zh': '弘大・延南洞・新村',
        'fr': 'Hongdae · Yeonnam · Sinchon',
      },
      'subtitle': {
        'ja': 'カフェ・ショッピング好きに',
        'ko': '카페・쇼핑을 좋아하는 분에게',
        'en': 'For café & shopping lovers',
        'zh': '适合喜欢咖啡厅购物的人',
        'fr': 'Pour les amateurs de cafés et shopping',
      },
      'landmarks': [
        {
          'name': '弘大',
    ...
    },
    {
      'id': 'seoul-gangnam',
      'region': 'seoul',
      'image': '/images/landmarks/lotte-world.webp',
      'title': {
        'ja': '江南・COEX・ロッテタワー',
        'ko': '강남・코엑스・롯데타워',
        'en': 'Gangnam · COEX · Lotte Tower',
        'zh': '江南・COEX・乐天塔',
        'fr': 'Gangnam · COEX · Lotte Tower',
      },
      'subtitle': {
        'ja': 'K-POP・トレンド好きに',
        'ko': 'K-POP・트렌드를 좋아하는 분에게',
        'en': 'For K-pop & trend lovers',
        'zh': '适合喜欢K-POP潮流的人',
        'fr': 'Pour les fans de K-pop et tendances',
      },
      'landmarks': [
        {
          'name': '江南',
    ...
    },
    {
      'id': 'seoul-culture',
      'region': 'seoul',
      'image': '/images/landmarks/insadong.webp',
      'title': {
        'ja': '昌徳宮・光化門・宗廟',
        'ko': '창덕궁・광화문・종묘',
        'en': 'Changdeokgung · Gwanghwamun · Jongmyo',
        'zh': '昌德宫・光化门・宗庙',
        'fr': 'Changdeokgung · Gwanghwamun · Jongmyo',
      },
      'subtitle': {
        'ja': '歴史と文化を楽しみたい方に',
        'ko': '역사와 문화를 즐기고 싶은 분에게',
        'en': 'For history & culture enthusiasts',
        'zh': '适合喜欢历史文化的人',
        'fr': 'Pour les passionnés d\'histoire et culture',
      },
      'landmarks': [
        {
          'name': '昌徳宮',
          'nameKo': '창덕궁',
          'nameEn': 'Changdeokgung',
          'lat': 37.5792,
          'lng': 126.991,
          'region': 'seoul',
        },
    ...
    },
    {
      'id': 'busan-beach',
      'region': 'busan',
      'image': '/images/landmarks/haeundae.webp',
      'title': {
        'ja': '海雲台・広安里・海東龍宮寺',
        'ko': '해운대・광안리・해동용궁사',
        'en': 'Haeundae · Gwangalli · Haedong Yonggungsa',
        'zh': '海云台・广安里・海东龙宫寺',
        'fr': 'Haeundae · Gwangalli · Haedong Yonggungsa',
      },
      'subtitle': {
        'ja': 'ビーチ・絶景を楽しみたい方に',
        'ko': '바다・절경을 즐기고 싶은 분에게',
        'en': 'For beach & scenic views',
        'zh': '适合喜欢海滩绝景的人',
        'fr': 'Pour les amateurs de plage et panoramas',
      },
      'landmarks': [
        {
          'name': '海雲台',
    ...
    },
    {
      'id': 'busan-culture',
      'region': 'busan',
      'image': '/images/landmarks/gamcheon-culture-village.webp',
      'title': {
        'ja': '甘川文化村・南浦洞',
        'ko': '감천문화마을・남포동',
        'en': 'Gamcheon · Nampo-dong · Jagalchi',
        'zh': '甘川文化村・南浦洞',
        'fr': 'Gamcheon · Nampo-dong · Jagalchi',
      },
      'subtitle': {
        'ja': 'アートとローカル体験が好きな方に',
        'ko': '아트와 로컬 체험을 좋아하는 분에게',
        'en': 'For art & local experiences',
        'zh': '适合喜欢艺术本地体验的人',
        'fr': 'Pour l\'art et les expériences locales',
      },
      'landmarks': [
        {
          'name': '甘川文化村',
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          tr(
            locale,
            ja: 'タップするだけで最適なホテルエリアがわかります',
            ko: '탭하면 바로 최적의 호텔 지역을 찾아줍니다',
            en: 'Tap to find the best hotel area',
            zh: '点击即可找到最佳酒店区域',
            fr: 'Appuyez pour trouver le meilleur quartier hôtelier',
          ),
          style: theme.textTheme.bodyMedium?.copyWith(
            color: AppTheme.mutedForeground,
          ),

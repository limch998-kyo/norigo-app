  ...
  static const _spots = {
    'kanto': [
      {'slug': 'tokyo-tower', 'name': '東京タワー', 'nameKo': '도쿄타워', 'nameEn': 'Tokyo Tower', 'lat': 35.6586, 'lng': 139.7454, 'image': 'tokyo-tower',
       'desc': {'ja': '1958年完成の東京のシンボル。展望台から都内を一望。', 'ko': '1958년에 완공된 도쿄의 상징. 전망대에서 도쿄 전경 감상.', 'en': 'Tokyo\'s iconic 1958 tower with panoramic views.', 'fr': 'Tokyo\'}},
      {'slug': 'asakusa-senso-ji', 'name': '浅草寺', 'nameKo': '아사쿠사 센소지', 'nameEn': 'Sensoji Temple', 'lat': 35.7148, 'lng': 139.7967, 'image': 'asakusa-senso-ji',
       'desc': {'ja': '東京最古の寺院。雷門と仲見世通りが人気。', 'ko': '도쿄에서 가장 오래된 사찰. 가미나리몬과 나카미세 거리.', 'en': 'Tokyo\'s oldest temple with Thunder Gate.', 'fr': 'Tokyo\'}},
      {'slug': 'shibuya-crossing', 'name': '渋谷スクランブル交差点', 'nameKo': '시부야스크램블교차점', 'nameEn': 'Shibuya Crossing', 'lat': 35.6595, 'lng': 139.7004, 'image': 'shibuya-crossing',
       'desc': {'ja': '世界で最も有名な交差点。渋谷のシンボル。', 'ko': '세계에서 가장 유명한 교차로. 시부야의 상징.', 'en': 'The world\'s most famous crossing.', 'fr': 'The world\'}},
      {'slug': 'meiji-shrine', 'name': '明治神宮', 'nameKo': '메이지신궁', 'nameEn': 'Meiji Shrine', 'lat': 35.6764, 'lng': 139.6993, 'image': 'meiji-shrine',
       'desc': {'ja': '渋谷の森の中にある荘厳な神社。', 'ko': '시부야 숲 속에 자리한 장엄한 신사.', 'en': 'Serene shrine in Shibuya\'s forest.', 'fr': 'Serene shrine in Shibuya\'}},
      {'slug': 'shinjuku-gyoen', 'name': '新宿御苑', 'nameKo': '신주쿠교엔', 'nameEn': 'Shinjuku Gyoen', 'lat': 35.6852, 'lng': 139.71, 'image': 'shinjuku-gyoen',
       'desc': {'ja': '日本庭園・英国式・フランス式の3つの庭園。', 'ko': '일본식·영국식·프랑스식 3개의 정원.', 'en': 'Three-style gardens in central Tokyo.', 'fr': 'Three-style gardens in central Tokyo.'}},
      {'slug': 'tokyo-skytree', 'name': '東京スカイツリー', 'nameKo': '도쿄스카이트리', 'nameEn': 'Tokyo Skytree', 'lat': 35.7101, 'lng': 139.8107, 'image': 'tokyo-skytree',
       'desc': {'ja': '高さ634mの世界一高い電波塔。', 'ko': '높이 634m의 세계에서 가장 높은 전파탑.', 'en': 'World\'s tallest broadcasting tower at 634m.', 'fr': 'World\'}},
    ],
    'kansai': [
      {'slug': 'kinkaku-ji', 'name': '金閣寺', 'nameKo': '금각사', 'nameEn': 'Kinkaku-ji', 'lat': 35.0394, 'lng': 135.7292, 'image': 'kinkaku-ji',
       'desc': {'ja': '金箔で覆われた美しい寺院。池に映る姿が絶景。', 'ko': '금박으로 덮인 아름다운 사찰. 연못에 비치는 모습이 절경.', 'en': 'Golden pavilion reflected in mirror pond.', 'fr': 'Golden pavilion reflected in mirror pond.'}},
      {'slug': 'fushimi-inari-taisha', 'name': '伏見稲荷大社', 'nameKo': '후시미이나리타이샤', 'nameEn': 'Fushimi Inari', 'lat': 34.9671, 'lng': 135.7727, 'image': 'fushimi-inari-taisha',
       'desc': {'ja': '千本鳥居で有名な京都の神社。', 'ko': '붉은 도리이 터널로 유명한 교토의 신사.', 'en': 'Famous for thousands of vermillion torii gates.', 'fr': 'Famous for thousands of vermillion torii gates.'}},
      {'slug': 'kiyomizu-dera', 'name': '清水寺', 'nameKo': '기요미즈데라', 'nameEn': 'Kiyomizu-dera', 'lat': 34.9949, 'lng': 135.785, 'image': 'kiyomizu-dera',
       'desc': {'ja': '清水の舞台から京都を一望。世界遺産。', 'ko': '기요미즈 무대에서 교토 전경을 한눈에. 세계유산.', 'en': 'UNESCO World Heritage temple with wooden stage.', 'fr': 'UNESCO World Heritage temple with wooden stage.'}},
      {'slug': 'dotonbori', 'name': '道頓堀', 'nameKo': '도톤보리', 'nameEn': 'Dotonbori', 'lat': 34.6687, 'lng': 135.5013, 'image': 'dotonbori',
       'desc': {'ja': '大阪グルメの中心地。グリコサインが有名。', 'ko': '오사카 먹거리의 중심. 글리코 사인이 유명.', 'en': 'Osaka\'s food capital with famous Glico sign.', 'fr': 'Osaka\'}},
      {'slug': 'arashiyama', 'name': '嵐山', 'nameKo': '아라시야마', 'nameEn': 'Arashiyama', 'lat': 35.0094, 'lng': 135.667, 'image': 'arashiyama',
       'desc': {'ja': '竹林と渡月橋で有名な景勝地。', 'ko': '대나무숲과 토게츠교로 유명한 명소.', 'en': 'Scenic area with bamboo grove and Togetsukyo Bridge.', 'fr': 'Scenic area with bamboo grove and Togetsukyo Bridge.'}},
      {'slug': 'nijo-castle', 'name': '二条城', 'nameKo': '니조성', 'nameEn': 'Nijo Castle', 'lat': 35.0142, 'lng': 135.748, 'image': 'nijo-castle',
       'desc': {'ja': '徳川家康が建てた世界遺産の城。', 'ko': '도쿠가와 이에야스가 세운 세계유산 성.', 'en': 'Tokugawa-era castle, UNESCO World Heritage.', 'fr': 'Tokugawa-era castle, UNESCO World Heritage.'}},
    ],
    'seoul': [
      {'slug': 'myeongdong', 'name': '明洞', 'nameKo': '명동', 'nameEn': 'Myeongdong', 'lat': 37.5609, 'lng': 126.9858, 'image': 'myeongdong',
       'desc': {'ja': 'ソウル最大のショッピング・グルメエリア。', 'ko': '서울 최대의 쇼핑·먹거리 거리. 화장품과 패션.', 'en': 'Seoul\'s biggest shopping and food district.', 'fr': 'Seoul\'}},
      {'slug': 'hongdae', 'name': '弘大', 'nameKo': '홍대', 'nameEn': 'Hongdae', 'lat': 37.5574, 'lng': 126.9248, 'image': 'hongdae',
       'desc': {'ja': '若者文化の中心地。カフェやクラブが多い。', 'ko': '젊은이 문화의 중심지. 카페와 공연이 가득.', 'en': 'Youth culture hub with cafes and clubs.', 'fr': 'Youth culture hub with cafes and clubs.'}},
      {'slug': 'gangnam', 'name': '江南', 'nameKo': '강남', 'nameEn': 'Gangnam', 'lat': 37.4979, 'lng': 127.0276, 'image': 'gangnam',
       'desc': {'ja': 'K-POPで有名な高級エリア。', 'ko': 'K-pop으로 유명한 고급 상업지구.', 'en': 'Upscale district famous from K-pop.', 'fr': 'Upscale district famous from K-pop.'}},
      {'slug': 'gyeongbokgung', 'name': '景福宮', 'nameKo': '경복궁', 'nameEn': 'Gyeongbokgung', 'lat': 37.5796, 'lng': 126.977, 'image': 'gyeongbokgung',
       'desc': {'ja': '朝鮮王朝の正宮。守門将交代式が人気。', 'ko': '조선 왕조의 정궁. 수문장 교대식이 인기.', 'en': 'Joseon dynasty\'s main palace with guard ceremony.', 'fr': 'Joseon dynasty\'}},
      {'slug': 'itaewon', 'name': '梨泰院', 'nameKo': '이태원', 'nameEn': 'Itaewon', 'lat': 37.5344, 'lng': 126.9946, 'image': 'itaewon',
       'desc': {'ja': '多国籍レストランとバーが集まる国際的なエリア。', 'ko': '다양한 외국 음식점과 루프탑 바가 있는 국제적 동네.', 'en': 'International dining and nightlife hub.', 'fr': 'International dining and nightlife hub.'}},
      {'slug': 'insadong', 'name': '仁寺洞', 'nameKo': '인사동', 'nameEn': 'Insadong', 'lat': 37.5746, 'lng': 126.985, 'image': 'insadong',
       'desc': {'ja': '伝統的な茶屋やギャラリーが並ぶ文化通り。', 'ko': '전통 찻집과 미술관이 늘어선 문화 거리.', 'en': 'Cultural street with tea houses and galleries.', 'fr': 'Cultural street with tea houses and galleries.'}},
    ],
    'busan': [
      {'slug': 'haeundae', 'name': '海雲台', 'nameKo': '해운대', 'nameEn': 'Haeundae', 'lat': 35.1588, 'lng': 129.1604, 'image': 'haeundae',
       'desc': {'ja': '韓国最高のビーチリゾート。1.5kmの白砂浜。', 'ko': '한국 최고의 해수욕장. 1.5km 백사장.', 'en': 'Korea\'s premier beach with 1.5km white sand.', 'fr': 'Korea\'}},
      {'slug': 'gwangalli', 'name': '広安里', 'nameKo': '광안리', 'nameEn': 'Gwangalli', 'lat': 35.1534, 'lng': 129.1187, 'image': 'gwangalli',
       'desc': {'ja': '広安大橋の夜景が美しいビーチエリア。', 'ko': '광안대교 야경이 아름다운 해변 지역.', 'en': 'Beach area with beautiful bridge night view.', 'fr': 'Beach area with beautiful bridge night view.'}},
      {'slug': 'gamcheon-culture-village', 'name': '甘川文化村', 'nameKo': '감천문화마을', 'nameEn': 'Gamcheon Culture Village', 'lat': 35.0966, 'lng': 129.0105, 'image': 'gamcheon-culture-village',
       'desc': {'ja': '釜山のマチュピチュ。カラフルな家々と壁画。', 'ko': '부산의 마추픽추. 알록달록한 집과 벽화.', 'en': 'Busan\'s Machu Picchu with colorful houses.', 'fr': 'Busan\'}},
      {'slug': 'jagalchi-market', 'name': 'チャガルチ市場', 'nameKo': '자갈치시장', 'nameEn': 'Jagalchi Market', 'lat': 35.0966, 'lng': 129.0308, 'image': 'jagalchi-market',
       'desc': {'ja': '韓国最大の海鮮市場。新鮮な刺身が食べられる。', 'ko': '한국 최대의 해산물 시장. 신선한 회를 즐길 수 있는 곳.', 'en': 'Korea\'s largest seafood market with fresh sashimi.', 'fr': 'Korea\'}},
      {'slug': 'nampo-dong', 'name': '南浦洞', 'nameKo': '남포동', 'nameEn': 'Nampo-dong', 'lat': 35.0978, 'lng': 129.0267, 'image': 'nampo-dong',
       'desc': {'ja': '国際市場やBIFF広場がある釜山の繁華街。', 'ko': '국제시장과 BIFF광장이 있는 부산의 번화가.', 'en': 'Busan\'s bustling downtown with markets.', 'fr': 'Busan\'}},
      {'slug': 'centum-city', 'name': 'センタムシティ', 'nameKo': '센텀시티', 'nameEn': 'Centum City', 'lat': 35.1696, 'lng': 129.1289, 'image': 'centum-city',
       'desc': {'ja': '世界最大のデパートがある現代的商業エリア。', 'ko': '세계 최대 백화점이 있는 현대적 상업 중심지.', 'en': 'Modern hub with world\'s largest department store.', 'fr': 'Modern hub with world\'}},
    ],
  };
